...
AURA_FLEET: tuple[FleetService, ...] = (
    FleetService(
        ...
        port=9100,
        subscribes=("system.health", "execution.fills", "agents.verdicts", "ml.votes"),
        publishes=("owner.commands",),
    ),
    FleetService(
    ...
    FleetService(
        ...
        port=9106,
        subscribes=("agents.verdicts", "execution.fills"),
    ...
    FleetService(
        ...
        publishes=("execution.orders", "execution.fills"),
        financial_authority=True,
    ),
    FleetService(

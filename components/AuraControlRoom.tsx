...
type View =
  ...
  | "news" | "journal" | "studio" | "capabilities" | "system" | "owner" | "settings";

const NAV: Array<[View, string, string]> = [
  ["overview", "Overview", "OV"],
  ["trading", "Live Trading Desk", "TR"],
  ["settings", "Credentials & API Keys", "CF"],
  ["charts", "Live Charts", "CH"],
  ["markets", "Markets", "MK"],
  ["opportunities", "Opportunities", "OP"],
  ["portfolio", "Portfolio & Positions", "PF"],
  ["brain", "AI Brain", "AI"],
      ...
      <main className="main">
        <header className="topbar">
          ...
          <div className="top-actions">
            <span className="chip flex items-center gap-1.5 text-emerald-400 font-mono">
              <span className="inline-block w-2 h-2 rounded-full bg-emerald-400 animate-pulse"></span>
              LIVE
            </span>
            <button
              id="topbar-btn-settings"
              className={view === "settings" ? "chip good" : "chip"}
              onClick={() => setView("settings")}
            >
              ⚙️ API Keys & Brokers
            </button>
            <button
              id="topbar-btn-trading"
              className={view === "trading" ? "chip good" : "chip"}
        ...
        <div className="content">
          ...
          {/* Quick In-App Configuration Notice */}
          <div className="bg-slate-900/90 border border-slate-800 rounded-xl p-3 px-4 flex flex-wrap items-center justify-between gap-3">
            <div className="flex items-center gap-2.5 text-xs text-slate-300">
              <span className="text-base">🔑</span>
              <span>
                <strong>In-App Broker & AI Credentials:</strong> You can configure and test your MT5 accounts, Indian brokers (Angel One, Dhan, Shoonya), Ollama, and OpenAI directly inside the app without manual .env files.
              </span>
            </div>
            <button
              type="button"
          ...
          {view === "trading" && (
            <div className="space-y-6">
              <LiveTradingDesk onOrderExecuted={refresh} />
              <section className="grid two">
                <Panel title="Protected execution controls" badge="DEMO">
                  ...
                  <div className="safety-note">Orders route directly through protected MT5 DEMO adapter with hard RiskEngine limits.</div>
                </Panel>
          ...
          {view === "settings" && (
            <div className="space-y-4">
              <CredentialsManager onSaved={refresh} />
            </div>
          )}

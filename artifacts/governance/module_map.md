...
- Repository files: 431
- Python modules: 365
- Source modules: 191
- Test modules: 150
- Static test functions: 593
- Entrypoints: 44
...
| `final_decision_lineage_validation.txt` | 1 |
| `knowledge` | 2 |
| `lineage_replay_final_validation.txt` | 1 |
| `multi_ai_validation.txt` | 1 |
| `output` | 1 |
| `phase2_clock_lineage_validation.txt` | 1 |
| `phase2_replay_determinism_validation.txt` | 1 |
...
| `aura/agents/risk_policy.py` | source | agents | 9 | 2 | 4 |
| `aura/agents/service.py` | source | agents | 9 | 8 | 3 |
...
| `aura/core/pipeline.py` | source | core | 10 | 3 | 9 |
...
| `aura/domain/models.py` | source | domain | 1 | 0 | 63 |
...
| `aura/interface/operator_read_model.py` | source | interface | 13 | 1 | 3 |
| `aura/interface/runtime_bridge.py` | source | interface | 13 | 5 | 1 |
...
| `aura/knowledge/firewall.py` | source | knowledge | 8 | 1 | 7 |
| `aura/knowledge/local_corpus.py` | source | knowledge | 8 | 2 | 1 |
| `aura/knowledge/retrieval.py` | source | knowledge | 8 | 1 | 1 |
| `aura/lineage/__init__.py` | package_marker | lineage | 10 | 1 | 0 |
| `aura/lineage/decision.py` | source | lineage | 10 | 4 | 2 |
| `aura/lineage/replay.py` | source | lineage | 10 | 2 | 1 |
...
| `aura/maintenance/openai_developer.py` | source | maintenance | 15 | 3 | 1 |
...
| `aura/ops/end_to_end_gate.py` | source | ops | 15 | 18 | 0 |
| `aura/ops/health.py` | source | ops | 15 | 0 | 2 |
...
| `aura/ops/operator_interface_gate.py` | source | ops | 15 | 17 | 0 |
| `aura/ops/paper_trading_gate.py` | source | ops | 15 | 13 | 0 |
| `aura/ops/phase_gates.py` | source | ops | 0 | 0 | 13 |
...
| `aura/runtime/scanner.py` | source | runtime | 12 | 7 | 9 |
| `aura/runtime/supervisor.py` | source | runtime | 12 | 2 | 1 |
| `aura/strategy/base.py` | source | strategy | 7 | 1 | 3 |
...
| `examples/run_public_command_center.py` | entrypoint | examples | 12 | 6 | 0 |
...
| `tests/test_agent_audit.py` | test | validation | 1 | 6 | 0 |
...
| `tests/test_backtest_gate.py` | test | validation | 0 | 2 | 0 |
...
| `tests/test_decision_lineage.py` | test | validation | 1 | 6 | 0 |
...
| `tests/test_execution_parity.py` | test | validation | 1 | 6 | 0 |
| `tests/test_external_specialists.py` | test | validation | 1 | 4 | 0 |
| `tests/test_financial_corrections.py` | test | validation | 1 | 5 | 0 |
...
| `tests/test_knowledge_rag_gate.py` | test | validation | 0 | 2 | 0 |
| `tests/test_knowledge_retrieval.py` | test | validation | 8 | 2 | 0 |
...
| `tests/test_openai_integration.py` | test | validation | 1 | 6 | 0 |
...
| `tests/test_runtime_bridge.py` | test | validation | 1 | 9 | 0 |
...
| `tests/test_software_phase_dependencies.py` | test | validation | 0 | 1 | 0 |

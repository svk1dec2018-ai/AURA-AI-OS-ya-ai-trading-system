...
- Source modules: 136
- Test modules: 101
- Static test functions: 298
- Entrypoints: 16
- Known stub/incomplete candidates: 71
...
| `aura/agents/risk_policy.py` | source | agents | 9 | 2 | 1 |
...
| `aura/domain/models.py` | source | domain | 1 | 0 | 45 |
...
| `aura/evolution/core.py` | source | evolution | 7 | 0 | 7 |
...
| `aura/evolution/opportunity_audit.py` | source | evolution | 7 | 2 | 2 |
| `aura/evolution/paper_tracker.py` | source | evolution | 7 | 2 | 1 |
...
| `aura/markets/universe.py` | source | markets | 1 | 0 | 8 |
...
| `aura/research/lifecycle.py` | source | research | 7 | 0 | 6 |
| `aura/research/live_shadow_strategy_lab.py` | source | research | 7 | 3 | 1 |
| `aura/research/manifest.py` | source | research | 7 | 0 | 1 |
| `aura/research/paper_evidence.py` | source | research | 7 | 1 | 2 |
...
| `aura/runtime/free_public_strategy_lab.py` | source | runtime | 12 | 6 | 0 |
...
| `aura/runtime/scanner.py` | source | runtime | 12 | 6 | 5 |
...
| `tests/test_evolution_evaluator.py` | test | validation | 1 | 6 | 0 |
...
| `tests/test_free_public_ai_context.py` | test | validation | 1 | 3 | 0 |
...
| `tests/test_live_shadow_strategy_lab.py` | test | validation | 1 | 4 | 0 |
...
| `tests/test_strategy_governance.py` | test | validation | 7 | 1 | 0 |
